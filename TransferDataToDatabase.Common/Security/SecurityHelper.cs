...
using System.Text;
using TransferDataToDatabase.Common.Hash;

namespace TransferDataToDatabase.Common.Security
{
    public static class SecurityHelper
    {
        ...
        const string Passphrase = "Transactions";
        ...
        {
            return value.ToHashByte(HashHelper.HashType.Sha1);
        }
        ...
        public static void EncodeConfigFile(Assembly assembly)
        {
            ...
            foreach (
                var configuration in
                    parentPath.GetDirectories().SelectMany(directory => (from file in directory.GetFiles()
