...
using System.IO;
using System.Text;
using TransferDataToDatabase.Common.DateTime;

namespace TransferDataToDatabase.Common.String
{
    public static class StringHelper
    {
        ...
        #region public static string ToEnumDescription(this Enum value)
        ...
        #region public void ToLog(this string logMessage, TextWriter textWriter)
        public static void ToLog(this string logMessage, TextWriter textWriter)
        {
            textWriter.Write("\r\nداده صورت عملیات: ");
            textWriter.WriteLine("{0}", System.DateTime.Now.ToStandardPersianDateTime());
        ...
        #region  public static string ToFarsi(this string value)
        ...
        #region public static string Number2String(this string value)
        ...
        public static string ToNumber2String(this string value)
        {
            try
            {
                var stotal = "";
        ...
        #region public static bool IsNumerableInput(this string text)
        public static bool IsNumerableInput(this string text)
        {
            try
            {
                var number = Convert.ToInt64(text);
                _errorMessage = number.ToString();
                return true;
            }
            catch
            {
        ...
        #region public static string To3FarsiNumber(this long value)
        public static string To3FarsiNumber(this long value)
        {
            return ToFarsi(value.ToString("###,###,###,###,###,###,###,###,###,###,###,###") == ""
                ? "0"
                : value.ToString("###,###,###,###,###,###,###,###,###,###,###,###"));
        }
        ...
        #region public static string To3FarsiNumber(this int value)
        public static string To3FarsiNumber(this int value)
        {
            return ToFarsi(value.ToString("###,###,###,###,###,###,###,###,###,###,###,###") == ""
                ? "0"
                : value.ToString("###,###,###,###,###,###,###,###,###,###,###,###"));
