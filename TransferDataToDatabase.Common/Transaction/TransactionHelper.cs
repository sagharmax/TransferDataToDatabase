...
namespace TransferDataToDatabase.Common.Transaction
{
    public static class TransactionHelper
    {
        ...
        #region public enum ChequesStatus
        ...
        public static string[] GetBillsInfo(this string text)
        {
            return new[]
            {
                ...
                "تعداد فیش های فایل بانکی: " +
                    Convert.ToInt64(text.Substring(22)).To3FarsiNumber() + " فیش " +
                    "به مبلغ " + (Convert.ToInt64(text.Substring(12, 10))*1000).To3FarsiNumber() + " ریال"
            };
        }
        ...
        public static string GetBillsInfo4Saderat(this string text)
        {
            return "تعداد فیش های فایل بانکی: " +
                   Convert.ToInt64(text.Substring(28)).To3FarsiNumber() + " فیش " +
                   "به مبلغ " + Convert.ToInt64(text.Substring(12, 16)).To3FarsiNumber() + " ریال";
        }
