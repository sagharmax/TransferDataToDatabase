...
namespace TransferDataToDatabase.Common.Sql
{
    public static class SqlHelper
    {
        ...
        #region public static DataTable ToReverseRowsInDataTable(this DataTable inputTable)
        public static DataTable ToReverseRowsInDataTable(this DataTable inputTable)
        {
